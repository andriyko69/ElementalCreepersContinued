...
public class DarkCreeperRenderer extends CreeperRenderer {
    private static final ResourceLocation CREEPER_LOCATION = ResourceLocation.fromNamespaceAndPath(ElementalCreepersContinued.MOD_ID, "textures/entity/dark_creeper.png");

    public DarkCreeperRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
