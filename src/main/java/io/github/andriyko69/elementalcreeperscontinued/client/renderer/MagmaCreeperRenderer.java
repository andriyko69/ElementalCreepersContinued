...
public class MagmaCreeperRenderer extends CreeperRenderer {
    private static final ResourceLocation CREEPER_LOCATION = ResourceLocation.fromNamespaceAndPath(ElementalCreepersContinued.MOD_ID, "textures/entity/magma_creeper.png");

    public MagmaCreeperRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
