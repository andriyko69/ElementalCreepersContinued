...
public class PsychicCreeperRenderer extends CreeperRenderer {
    private static final ResourceLocation CREEPER_LOCATION = ResourceLocation.fromNamespaceAndPath(ElementalCreepersContinued.MOD_ID, "textures/entity/psychic_creeper.png");

    public PsychicCreeperRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
